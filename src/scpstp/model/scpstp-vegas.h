...
public:
   ...
   */
  ScpsTpVegas (const ScpsTpVegas& sock);
  virtual ~ScpsTpVegas (void);
   ...
   *
   * \param tcb internal congestion state
   * \param newState new congestion state to which the SCPSTP is going to switch
   */
